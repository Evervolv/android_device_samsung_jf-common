...
LINEEND=" \\"
COUNT=`wc -l ../jf-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../jf-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
LINEEND=" \\"
COUNT=`wc -l ../jf-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../jf-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
